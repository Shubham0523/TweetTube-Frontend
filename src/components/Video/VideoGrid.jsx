...
function VideoGrid({ videos = [], loading = true, fetching = false, gridClassName = "", itemClassName= "" }) {
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4 p-4 ">
          <div className="w-full rounded">
            <div className="relative mb-1 w-full pt-[50%]">
              <div className="absolute inset-0 dark:bg-slate-100/10 bg-zinc-200 rounded animate-pulse"></div>
            </div>
            <div className="mb-1 rounded dark:bg-slate-100/10 bg-zinc-200 animate-pulse h-8 w-full"></div>
            <div className="flex rounded text-gray-200 dark:bg-slate-100/10 bg-zinc-200 animate-pulse h-5 w-full"></div>
          </div>
          <div className="w-full rounded">
            <div className="relative mb-1 w-full pt-[50%]">
              <div className="absolute inset-0 dark:bg-slate-100/10 bg-zinc-200 rounded animate-pulse"></div>
  ...
  return (
    <section id="scrollable_feed_screen"  className={`w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0 ${gridClassName}`}   >
      <ul className={`grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4 p-4 ${itemClassName} `}>
        {videos?.length > 0 ? (
          videos?.map((video) => (
            <li className="w-full" key={video?._id}>
              <div className="relative mb-2 w-full pt-[56%]">
                ...
                <span className="absolute bottom-1 right-1 inline-block rounded bg-black text-white px-1.5 text-sm">
              ...
              <div className="flex gap-x-2">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold text-black dark:text-gray-200">
